def sonarChecks() {
    sh '''
        ...
        sonar-scanner -Dsonar.projectKey=${COMPONENT} -Dsonar.java.binaries=target/ -Dsonar.sources=. -Dsonar.login=c83e5f2df3ea9ac79a5029df5f37d7177535df6a -Dsonar.host.url=http://172.31.90.194:9000
